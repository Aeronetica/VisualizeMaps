    ...
    <rasterrenderer type="singlebandpseudocolor" band="1" alphaBand="-1" opacity="1" classificationMin="-304" classificationMax="-152.3" nodataColor="">
      ...
      <rastershader>
        <colorrampshader minimumValue="-304" colorRampType="INTERPOLATED" classificationMode="1" maximumValue="-152.3" clip="0" labelPrecision="4">
          ...
          <item alpha="255" value="-303.9" color="#ff0000" label="-1000ft"/>
          <item alpha="255" value="-152.4" color="#ff0000" label="-500ft"/>
          <item alpha="255" value="-152.3" color="#FFB6C1" label="-500ft"/>
          <item alpha="255" value="-60.96" color="#FFB6C1" label="-152.3000"/>
          <item alpha="255" value="-60.95" color="#FF8000" label="-152.3000"/>
          <item alpha="255" value="-31.01" color="#FF8000" label="-152.3000"/>
          <item alpha="0" value="-31" color="#ff00ff" label="-152.3000"/>
          <item alpha="0" value="31" color="#FFFFC1" label="-152.3000"/>
          <item alpha="255" value="31.01" color="#FFFF00" label="-152.3000"/>
          <item alpha="255" value="60.95" color="#FFFF00" label="200ft"/>
          <item alpha="255" value="60.96" color="#94e5ff" label="200ft"/>
          <item alpha="255" value="152.3" color="#0000ff" label="500ft"/>
          <item alpha="255" value="304" color="#0000ff" label="500ft"/>
          <item alpha="255" value="304.1" color="#4B0082" label="1000ft"/>
