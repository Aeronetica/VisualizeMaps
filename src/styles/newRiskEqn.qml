    ...
    <rasterrenderer classificationMax="nan" classificationMin="nan" band="1" alphaBand="-1" opacity="1" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader classificationMode="1" clip="0" colorRampType="INTERPOLATED">
          ...
          <item color="#0000FF" label="" alpha="255" value="-1"/>
          <item color="#00FF00" label="" alpha="255" value="0"/>
          <item color="#FFFF00" label="" alpha="255" value="0.1"/>
          <item color="#FFFF00" label="" alpha="255" value="1701"/>
          <item color="#FFA500" label="" alpha="255" value="1701.1"/>
          <item color="#FFA500" label="" alpha="255" value="3837"/>
          <item color="#FF0000" label="" alpha="255" value="3837.1"/>
          <item color="#FF0000" label="" alpha="0" value="32768"/>
