    ...
    <rasterrenderer classificationMax="nan" classificationMin="nan" band="1" alphaBand="-1" opacity="1" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader classificationMode="1" clip="0" colorRampType="INTERPOLATED">
          ...
          <item color="#00FF00" label="" alpha="100" value="9.9"/>
            <item color="#FFFF00" label="" alpha="100" value="10"/>
          <item color="#FFFF00" label="" alpha="100" value="19.9"/>
          <item color="#FF0000" label="" alpha="100" value="20"/>
          <item color="#FF0000" label="" alpha="100" value="90"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
